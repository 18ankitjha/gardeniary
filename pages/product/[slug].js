    ...
    <section className="text-gray-600 body-font overflow-hidden">
      <div className="container px-5 py-16 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <img alt="ecommerce" className="lg:w-1/2 px-24 w-full lg:h-auto  object-cover object-top rounded" src="https://m.media-amazon.com/images/I/71yvfy+CS5L._SX679_.jpg" />
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            <h2 className="text-sm title-font text-gray-500 tracking-widest">Ugaoo</h2>
            <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">Money Plant(S)</h1>
            ...
            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
              <div className="flex">
                ...
                <button className="border-2 border-gray-300 ml-1 bg-orange-900 rounded-full w-6 h-6 focus:outline-none"></button>
            ...
            <div className="flex">
              <span className="title-font font-medium text-2xl text-gray-900">₹500.00</span>
              <button onClick={()=> addtoCart(slug,1,499,"Money Plant","S","White")} className="flex ml-4 text-white bg-green-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-green-600 rounded">Add to cart</button>
              <button className="flex ml-4 text-white bg-green-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-green-600 rounded">Buy Now</button>
