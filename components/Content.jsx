...
const Content = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Plant The Garden</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Are you a nature love?Why not help us to nurture Nature!!!</p>
    </div>
